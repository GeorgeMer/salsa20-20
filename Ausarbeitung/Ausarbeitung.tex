...
rowRound und columRound zu salsa\_core zusammengefasst.

\begin{center}
    \begin{tikzpicture}[trim axis left, trim axis right]
        \begin{axis}[
                symbolic x coords={\_\_vfprintf\_internal, salsa\_core, rotateLeft, salsa\_crypt},
                xtick = {\_\_vfprintf\_internal, salsa\_core, rotateLeft, salsa\_crypt},
            ...
            (rotateLeft,11.72) (salsa\_crypt,4.59)};
    
            \addplot[red,fill=red!30]
            coordinates {(\_\_vfprintf\_internal,40.27) (salsa\_core,10.86)
                    (rotateLeft,12.24) (salsa\_crypt,5.85)};
    
            \addplot[violet,fill=violet!30]
            coordinates {(\_\_vfprintf\_internal,26.71) (salsa\_core,9.2)
                    (rotateLeft,42.49) (salsa\_crypt,0.71)};
...
V1 gegenüber V0 bei salsa\_core liegt, da hier auf das Transponieren der Matrix verzichtet wird.
