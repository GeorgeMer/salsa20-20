...
\begin{center}
    \begin{tikzpicture}[trim axis left, trim axis right]
        \begin{axis}[
            ...
            \addplot[blue,fill=blue!30]
            coordinates {(\_\_vfprintf\_internal,5.34) (salsa\_core,1.85)
            (rotateLeft,1.59) (salsa\_crypt,0.62)};
    
            \addplot[red,fill=red!30]
            coordinates {(\_\_vfprintf\_internal,5.02) (salsa\_core,1.35)
                    (rotateLeft,1.52) (salsa\_crypt,0.73)};
    
            \addplot[violet,fill=violet!30]
            coordinates {(\_\_vfprintf\_internal,8.83) (salsa\_core,3.04)
                    (rotateLeft,14.05) (salsa\_crypt,0.23)};
