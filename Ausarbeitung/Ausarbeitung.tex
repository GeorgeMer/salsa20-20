...
\begin{center}
    \begin{tikzpicture}[trim axis left, trim axis right]
        \begin{axis}[
                symbolic x coords={__vfprintf_internal, salsa_core, rowRound, columRound, rotateLeft, salsa_crypt},
                xtick = {__vfprintf_internal, salsa_core, rowRound, columRound, rotateLeft, salsa_crypt},
                legend style={at={(0.5,-0.15)},
                        anchor=north,legend columns=-1},
                ybar,
                ymin=0,
            ...
            \addplot[blue,fill=blue!30]
            coordinates {(__vfprintf_internal,39.40) (salsa_core,13.64)
                    (rowRound,0) (columRound,0) (rotateLeft,11.72) (salsa_crypt,4.59)};
