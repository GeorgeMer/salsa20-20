...
Durch Analyse der drei Implementierung mit dem Tool perf - unter 
den gleichen Testbedingungen als zuvor, mit der Änderung, dass nur mit O3 kompiliert wurde 
- zeigt sich, warum V1 etwas schneller als V0 ist und warum V2 langsamer ist.

\begin{center}
    \begin{tikzpicture}[trim axis left, trim axis right]
        \begin{axis}[
                symbolic x coords={\_\_vfprintf\_internal, salsa\_core, rowRound, columRound, rotateLeft, salsa\_crypt},
                xtick = {\_\_vfprintf\_internal, salsa\_core, rowRound, columRound, rotateLeft, salsa\_crypt},
                ...
                ymin=0,
                ymajorgrids=true,
                ylabel=Anteil an Gesamtlaufzeit in \%,
                bar width=6mm,
                width=150mm,
                height=\axisdefaultheight,
            ...
            \addplot[blue,fill=blue!30]
            coordinates {(\_\_vfprintf\_internal,39.40) (salsa\_core,13.64)
            (rowRound,0) (columRound,0) (rotateLeft,11.72) (salsa\_crypt,4.59)};
    
            \addplot[red,fill=red!30]
            coordinates {(\_\_vfprintf\_internal,40.27) (salsa\_core,3.47)
                    (rowRound,3.78) (columRound,3.61) (rotateLeft,12.24) (salsa\_crypt,5.85)};
    
            \addplot[violet,fill=violet!30]
            coordinates {(\_\_vfprintf\_internal,26.71) (salsa\_core,1.55)
                    (rowRound,3.88) (columRound,3.77) (rotateLeft,42.49) (salsa\_crypt,0.71)};
